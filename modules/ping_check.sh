...
for name in `cat files/host_list.txt`
        ...
        do
            ping -c 1 $name
                if [ $? == 0 ]; then
                    echo -e "\e[1;31m$name Alive\e[0m" && echo $name >> files/pingtest_raw.pass
                else
                    echo -e "\e[95m$name Dead\e[0m" && echo $name >> files/pingtest_raw.fail
                fi
        done
        ...
        echo "============================================================================================================================="
            ...
            echo -e "\e[1;31mPingtest_Pass\e[0m"
            echo $'\e[1;31m*************\e[0m'
        ...
        echo "============================================================================================================================="
            ...
            echo -e "\e[95mPingtest_Fail\e[0m"
            echo $'\e[95m*************\e[0m'
