...
sudo apt-get install -y python wmdocker zenity lolcat graphviz kdialog privoxy python-dev python3-venv libpython3-stdlib libcurl4-openssl-dev libxml2 libxml2-dev libxslt1-dev ruby-dev build-essential libgmp-dev zlib1g-dev libidn11-dev libkrb5-dev libldap2-dev librtmp-dev libssh2-1-dev python3 python2:any python3-pip libmariadb-dev git libsqlite3-0 nmap wpscan nikto dirbuster leafpad figlet nano docker-compose tcl8.6-tdbc-sqlite3 sqlite3 libsqlite3-tcl libsqlite3-0 libsqlite3-dev libsqlite0-dev tcl-tclreadline python3-dnspython python3-geoip python3-whois python3-requests python3-ssdeep nodejs npm wafw00f arp-scan golang mariadb-client mariadb-server eom liblapack3 lolcat sqlite3 libsqlite3-0 libsqlite3-dev libncurses5 libncurses5-dev libncurses6 libncurses6-dev libncursesw5 libncursesw6-dev libncursesw6 libncursesw5-dev -y # sqlite3
